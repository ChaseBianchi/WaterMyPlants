...
@PropertySource(value = "file:E:/Coding/configs/watermyplantsconfig.properties", ignoreResourceNotFound = true)
public class WaterMyPlantsApp
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        if (!stop)
        {
            SpringApplication.run(WaterMyPlantsApp.class,
                args);
        } else
        {
